...
export default function Members() {
    ...
    return (
        ...
        >
        <Box>
            <Typography variant='h1' color="white" textAlign="center" paddingBottom="50px" >
            Members
            </Typography>
        </Box>
...

        {
            ...
            <MemberCard name={member.name} role={member.role} image={member.profileImage}></MemberCard>
            )
        }
